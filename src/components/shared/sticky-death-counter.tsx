    ...
    <div className="fixed top-0 left-0 right-0 z-50 border-b border-red-950/40 bg-[#060404]/[0.94] backdrop-blur-xl">
      <div className="flex items-center justify-center gap-2 px-3 py-1.5 sm:gap-3 sm:px-4 sm:py-2">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <span className="hidden text-[10px] font-mono font-semibold uppercase tracking-[2px] text-red-400/80 sm:inline">
            {liveBadge}
          </span>
        </div>
        ...
        <div className="flex min-w-0 items-center gap-1.5 sm:gap-2">
          ...
          <span className="truncate text-[10px] tracking-wide text-white/60 sm:text-[10px] sm:tracking-widest">
            {label}
          </span>
        </div>
      </div>
